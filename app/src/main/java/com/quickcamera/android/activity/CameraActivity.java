...
import com.quickcamera.android.FoldersActivity;
import com.quickcamera.android.R;
import com.quickcamera.android.adapters.ImageRecyclerAdapter;
...
public class CameraActivity extends AppCompatActivity {
    ...
    int count = 0;
    File myDir;
    TextView img_name, counter, done_btn;
    String fname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        folderName = getIntent().getExtras().getString(Constants.FOLDER_NAME);
        Log.e("folderName", "" + folderName);
        img_name.setText(folderName);
        ...
        done_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (list.size() != 0) {
                    ...
                    Toast.makeText(CameraActivity.this, "Please click Photo", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycler_scan_sv);
